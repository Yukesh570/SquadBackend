    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Type', models.CharField(choices=[('ADMIN', 'ADMIN'), ('STAFF_VIEWER', 'STAFF_VIEWER'), ('STAFF', 'STAFF'), ('STAFF_EDITOR', 'STAFF_EDITOR'), ('SUPER', 'SUPER'), ('MERCHANT', 'MERCHANT'), ('MERCHANT_ADMIN', 'MERCHANT_ADMIN')], default='MERCHANT', max_length=20)),
